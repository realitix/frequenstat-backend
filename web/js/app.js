...
$(document).ready(function() {
	...
	$('#logout a').click(function(e) {
		...
		// ask verification
		$.SmartMessageBox({
			title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Déconnexion <span class='txt-color-orangeDark'><strong>" + $('#show-shortcut').text() + "</strong></span> ?",
			content : "Vous pouvez augmenter encore plus la sécurité en quittant le navigateur web après la déconnexion.",
			buttons : '[Non][Oui]'
