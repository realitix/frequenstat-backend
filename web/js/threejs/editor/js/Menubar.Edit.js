Menubar.Edit = function ( editor ) {
	...
	var menuConfig = [
		...
		createOption( 'Cloner', onCloneOptionClick ),
		createOption( 'Supprimer', onDeleteOptionClick ),
		createDivider(),

		createOption( 'Convertir', onConvertOptionClick ),
		createOption( 'Ecraser', onFlattenOptionClick )
	];

	var optionsPanel = UI.MenubarHelper.createOptionsPanel( menuConfig );

	return UI.MenubarHelper.createMenuContainer( 'Edition', optionsPanel );
}
