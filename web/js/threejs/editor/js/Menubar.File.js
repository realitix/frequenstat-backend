Menubar.File = function ( editor ) {
	...
	var menuConfig = [
		createOption( 'Nouveau', onNewOptionClick ),
		createOption( 'Recharger', onImportOptionClick ),
		createOption( 'Sauvegarder', onExportGeometryOptionClick )
	];

	var optionsPanel = UI.MenubarHelper.createOptionsPanel( menuConfig );

	return UI.MenubarHelper.createMenuContainer( 'Fichier', optionsPanel );
