...
\t\t\t\t\t\t\t\t<li>Nombre de Smartphones détectés: ";
        // line 34
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["global"]) ? $context["global"] : $this->getContext($context, "global")), "stations"), "html", null, true);
        echo "</li>
\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t<li>Dernière mise à jour : ";
            // line 55
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["p"]) ? $context["p"] : $this->getContext($context, "p")), "modified"), "d/m/Y à H:i"), "html", null, true);
            echo "</li>
\t\t\t\t\t\t\t\t\t<li>Nombre de Smartphones détectés: ";
            // line 56
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["p"]) ? $context["p"] : $this->getContext($context, "p")), "stations"), "html", null, true);
            echo "</li>
\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
