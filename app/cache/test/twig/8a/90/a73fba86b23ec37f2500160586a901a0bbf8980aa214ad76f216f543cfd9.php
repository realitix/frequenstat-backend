...
\t";
        // line 16
        if ((!(isset($context["placeOk"]) ? $context["placeOk"] : $this->getContext($context, "placeOk")))) {
            // line 17
...
\t    </div>
\t";
        } elseif ((!(isset($context["confOk"]) ? $context["confOk"] : $this->getContext($context, "confOk")))) {
            // line 23
            echo "\t    <div class=\"alert alert-warning\">
\t        <i class=\"fa fa-fw fa-warning\"></i>
\t        <strong>Attention</strong>
...
\t    captureUrl: '";
        // line 59
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tracker_ajax_capture_getLastMinute", array("id" => $this->getAttribute((isset($context["place"]) ? $context["place"] : $this->getContext($context, "place")), "id"))), "html", null, true);
        echo "'
\t});
</script>
";
