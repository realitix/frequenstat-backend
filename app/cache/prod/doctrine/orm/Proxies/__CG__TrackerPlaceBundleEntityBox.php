 ...
 */
class Box extends \Tracker\PlaceBundle\Entity\Box implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'id', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'name', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'place', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'serialNumber', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'version', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'position', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'created', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\Box' . "\0" . 'modified');
        }
