 ...
 */
class Capture extends \Tracker\CaptureBundle\Entity\Capture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tracker\\CaptureBundle\\Entity\\Capture' . "\0" . 'id', '' . "\0" . 'Tracker\\CaptureBundle\\Entity\\Capture' . "\0" . 'dateCapture', '' . "\0" . 'Tracker\\CaptureBundle\\Entity\\Capture' . "\0" . 'power', '' . "\0" . 'Tracker\\CaptureBundle\\Entity\\Capture' . "\0" . 'box', '' . "\0" . 'Tracker\\CaptureBundle\\Entity\\Capture' . "\0" . 'station');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Capture $proxy) {
    ...
    public function setPower($power)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPower', array($power));
    ...
    public function getPower()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPower', array());
