 ...
 */
class Purchase extends \Tracker\BillingBundle\Entity\Purchase implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Purchase' . "\0" . 'id', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Purchase' . "\0" . 'created', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Purchase' . "\0" . 'status', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Purchase' . "\0" . 'invoice', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Purchase' . "\0" . 'user', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Purchase' . "\0" . 'option');
        }
