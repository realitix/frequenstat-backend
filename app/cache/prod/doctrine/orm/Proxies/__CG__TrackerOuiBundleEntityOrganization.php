...
namespace Proxies\__CG__\Tracker\OuiBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Organization extends \Tracker\OuiBundle\Entity\Organization implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tracker\\OuiBundle\\Entity\\Organization' . "\0" . 'id', '' . "\0" . 'Tracker\\OuiBundle\\Entity\\Organization' . "\0" . 'name', '' . "\0" . 'Tracker\\OuiBundle\\Entity\\Organization' . "\0" . 'mac', '' . "\0" . 'Tracker\\OuiBundle\\Entity\\Organization' . "\0" . 'os');
        }
