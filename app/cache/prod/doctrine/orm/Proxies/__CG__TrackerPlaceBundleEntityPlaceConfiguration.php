 ...
 */
class PlaceConfiguration extends \Tracker\PlaceBundle\Entity\PlaceConfiguration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\PlaceConfiguration' . "\0" . 'id', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\PlaceConfiguration' . "\0" . 'content', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\PlaceConfiguration' . "\0" . 'created', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\PlaceConfiguration' . "\0" . 'modified', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\PlaceConfiguration' . "\0" . 'place', '' . "\0" . 'Tracker\\PlaceBundle\\Entity\\PlaceConfiguration' . "\0" . 'configuration');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PlaceConfiguration $proxy) {
