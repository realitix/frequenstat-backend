 ...
 */
class Message extends \Tracker\TicketBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tracker\\TicketBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'Tracker\\TicketBundle\\Entity\\Message' . "\0" . 'content', '' . "\0" . 'Tracker\\TicketBundle\\Entity\\Message' . "\0" . 'created', '' . "\0" . 'Tracker\\TicketBundle\\Entity\\Message' . "\0" . 'user', '' . "\0" . 'Tracker\\TicketBundle\\Entity\\Message' . "\0" . 'ticket', '' . "\0" . 'Tracker\\TicketBundle\\Entity\\Message' . "\0" . 'close');
        }
