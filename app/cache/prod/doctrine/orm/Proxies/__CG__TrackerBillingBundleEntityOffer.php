 ...
 */
class Offer extends \Tracker\BillingBundle\Entity\Offer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Offer' . "\0" . 'id', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Offer' . "\0" . 'name', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Offer' . "\0" . 'description', '' . "\0" . 'Tracker\\BillingBundle\\Entity\\Offer' . "\0" . 'options');
        }
