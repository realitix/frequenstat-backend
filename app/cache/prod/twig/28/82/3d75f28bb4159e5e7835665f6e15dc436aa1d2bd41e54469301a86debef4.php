...
/* TrackerAdminBundle:Place:add.html.twig */
class __TwigTemplate_28823d75f28bb4159e5e7835665f6e15dc436aa1d2bd41e54469301a86debef4 extends Twig_Template
{
...
\t<li><a href=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tracker_admin_user_view", array("id" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id"))), "html", null, true);
        echo "\">";
        ...
        echo "</a></li>
\t<li>Création d'un point de vente</li>
";
    }
...
\t\t\t<h1 class=\"page-title txt-color-blueDark\"><i class=\"fa-fw fa fa-table\"></i> Création d'un point de vente </span></h1>
\t\t</div>
\t</div>
\t
...
\t\t\t\t\t\t<h2>Création d'un point de vente</h2>
\t\t\t\t\t</header>
\t\t\t\t\t<div>
        ...
        echo "
                                    ...
                                    <section>
                                        <label class=\"select\">
                                            ";
        // line 50
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "placeType"), 'widget');
        echo "
                                            <i></i>
                                        </label>
                                    </section>
...
";
    ...
    {
        return "TrackerAdminBundle:Place:add.html.twig";
    }
