...
\t                            <option value=\"";
        ...
        echo "\" ";
        if (((isset($context["interval"]) ? $context["interval"] : null) == twig_constant("\\Tracker\\CaptureBundle\\Service\\CaptureManager::TYPE_24H"))) {
...
\t                            <option value=\"";
        ...
        echo "\" ";
        if (((isset($context["interval"]) ? $context["interval"] : null) == twig_constant("\\Tracker\\CaptureBundle\\Service\\CaptureManager::TYPE_7DAYS"))) {
            echo "selected=\"selected\"";
        }
        echo ">7 jours</option>
\t                            <option value=\"";
        ...
        echo "\" ";
        if (((isset($context["interval"]) ? $context["interval"] : null) == twig_constant("\\Tracker\\CaptureBundle\\Service\\CaptureManager::TYPE_1MONTH"))) {
            echo "selected=\"selected\"";
        }
        echo ">1 mois</option>
\t                            <option value=\"";
        ...
        echo "\" ";
        if (((isset($context["interval"]) ? $context["interval"] : null) == twig_constant("\\Tracker\\CaptureBundle\\Service\\CaptureManager::TYPE_CUSTOM"))) {
            echo "selected=\"selected\"";
        }
...
\t\t\t\t\t\t\t\t<input class=\"datetimepicker\" placeholder=\"Début\" type=\"text\" name=\"begin[]\" ";
        // line 23
        if (($this->getAttribute($this->getAttribute((isset($context["dates"]) ? $context["dates"] : null), 0, array(), "array", false, true), "begin", array(), "any", true, true) && $this->getAttribute($this->getAttribute((isset($context["dates"]) ? $context["dates"] : null), 0, array(), "array"), "begin"))) {
            echo " value=\"";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["dates"]) ? $context["dates"] : null), 0, array(), "array"), "begin"), "Y-m-d H:i"), "html", null, true);
            echo "\" ";
        }
        echo "/>
\t\t\t\t\t\t\t</label>
...
\t\t\t\t\t\t\t\t<input class=\"datetimepicker\" placeholder=\"Fin\" type=\"text\" name=\"end[]\" ";
        // line 28
        if (($this->getAttribute($this->getAttribute((isset($context["dates"]) ? $context["dates"] : null), 0, array(), "array", false, true), "end", array(), "any", true, true) && $this->getAttribute($this->getAttribute((isset($context["dates"]) ? $context["dates"] : null), 0, array(), "array"), "end"))) {
            echo " value=\"";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["dates"]) ? $context["dates"] : null), 0, array(), "array"), "end"), "Y-m-d H:i"), "html", null, true);
            echo "\" ";
        }
        echo "/>
\t\t\t\t\t\t\t</label>
