...
\t<li><a href=\"";
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("tracker_admin_user_view", array("id" => $this->getAttribute($this->getAttribute((isset($context["place"]) ? $context["place"] : null), "user"), "id"))), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["place"]) ? $context["place"] : null), "user"), "firstName"), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["place"]) ? $context["place"] : null), "user"), "lastName"), "html", null, true);
        echo "</a></li>
        ...
        echo "
                                    ...
                                    <section>
                                        <label class=\"input\">
                                            ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "serialNumber"), 'widget');
        echo "
                                        </label>
                                    </section>
                                    <section>
                                        <label class=\"input\">
                                            ";
        // line 50
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "version"), 'widget');
        echo "
                                        </label>
                                    </section>
                                </fieldset>
