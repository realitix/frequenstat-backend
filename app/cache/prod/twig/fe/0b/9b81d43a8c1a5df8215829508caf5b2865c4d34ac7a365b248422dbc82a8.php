...
\t\t\t\t\t\t\t\t\t\t<input class=\"datetimepicker\" placeholder=\"Début\" type=\"text\" name=\"begin[]\" value=\"";
            // line 55
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["d"]) ? $context["d"] : null), "begin"), "html", null, true);
            echo "\" />
\t\t\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t\t\t</section>
\t\t\t\t\t\t\t\t<section class=\"col col-6\">
...
\t\t\t\t\t\t\t\t\t\t<input class=\"datetimepicker\" placeholder=\"Fin\" type=\"text\" name=\"end[]\" value=\"";
            // line 60
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["d"]) ? $context["d"] : null), "end"), "html", null, true);
            echo "\" />
\t\t\t\t\t\t\t\t\t</label>
\t\t\t\t\t\t\t\t</section>
\t\t\t\t\t\t\t</div>
...
\t\t\t";
        // line 96
        if ((!(isset($context["hasCapture"]) ? $context["hasCapture"] : null))) {
            // line 97
            echo "\t\t\t\t<div class=\"alert alert-danger fade in\">
\t\t\t\t\t<i class=\"fa-fw fa fa-times\"></i>
